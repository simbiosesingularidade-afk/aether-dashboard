    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-cyan-400 font-semibold text-lg">AETHER v22.60 — DIP-BUYER LIVE</p>
            ...
            <section className="mb-8 bg-gradient-to-br from-orange-900/20 via-yellow-900/10 to-red-900/20 border border-orange-500/30 rounded-2xl p-6 backdrop-blur-sm">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-white flex items-center gap-3">
                  ...
                  Pump Radar v22.60 — Radar + Entrada no INÍCIO
                  ...
                  <div className="mt-6 bg-gradient-to-r from-emerald-500/10 via-cyan-500/10 to-emerald-500/10 border border-emerald-500/20 rounded-xl p-5">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="font-bold text-emerald-400 text-lg mb-4">Trailing Stop v22.60 — deixa o vencedor correr (RR 2:1)</h3>
  ...
  const rules = [
    ...
    },
    {
      ...
      rules: [
        ...
        { title: "OPORTUNIDADE (29 tokens)", desc: "score ≥ 50 · RISK_OFF: vol≥0.15 + mom>-1.0 (v22.60 afrouxado p/ dip)", example: "Dip a virar com score 52 → entra com size reduzido" },
    ...
    {
      category: "🌡️ REGIME FILTER v22.60",
      rules: [
    ...
    {
      category: "🛡️ ANTI_TOPO v22.60 — Bloqueia entrada no topo",
      rules: [
    ...
    {
      category: "⚙️ RISK MANAGEMENT v22.60",
      rules: [
    ...
    {
      category: "🔒 TRAILING STOP v22.60 — deixa o vencedor correr (RR 2:1)",
      rules: [
        { title: "Micro-trail", desc: "DESLIGADO (v22.60) — raspava vencedores a +1% (RR caía para 0.27)", example: "Já não corta o lucro cedo" },
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-br from-orange-900/20 via-yellow-900/10 to-red-900/20 border border-orange-500/30 rounded-2xl p-6 backdrop-blur-sm">
        <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
          <span className="text-3xl">📡</span>
          Pump Radar v22.60 — só ALERTA (não entra)
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="bg-gray-900/50 border border-emerald-500/20 rounded-lg p-4">
                <div className="font-bold text-emerald-400 mb-1">ATIVOS (v22.60)</div>
