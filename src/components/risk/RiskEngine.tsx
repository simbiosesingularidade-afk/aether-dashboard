export function RiskEngine() {
  const riskParams = [
    ...
    { label: 'Position Size Máx', value: '8% equity (v22.34)', highlight: true },
    ...
    { label: 'Loss Trailing v22.34', value: 'pnl ≤ -1.25% → fecha 15%×nível do gap(SL→preço)', color: 'text-loss' },
    ...
    { label: 'Pump Entry Size / SL / Vol', value: '$5 | 4% | 2.15× (v22.34)', color: 'text-info' },
