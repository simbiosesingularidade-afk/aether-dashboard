export function RiskEngine() {
  const riskParams = [
    ...
    { label: 'Position Size Máx', value: '8% equity (v22.35)', highlight: true },
    ...
    { label: 'Loss Trailing v22.35', value: 'pnl ≤ -1.25% → fecha 15%×nível do gap(SL→preço)', color: 'text-loss' },
    ...
    { label: 'MB Filtros', value: 'mom3≥0.65% | vol≥1.5× | RSI 42–68 | BB≥0.02', color: 'text-info' },
    ...
    { label: 'Pump Entry Size / SL / Vol', value: '$5 | 4% | 2.15× (v22.35)', color: 'text-info' },
