export function RiskEngine() {
  const riskParams = [
    ...
    { label: 'Position Size Máx', value: '8% equity (v22.57)', highlight: true },
    ...
    { label: 'Loss Trailing v22.57', value: 'pnl ≤ -1.25% → fecha 15%×nível do gap(SL→preço)', color: 'text-loss' },
    ...
    { label: 'Pump Entry Size / SL / Vol', value: '$5 | 6% | 3.0× (v22.57)', color: 'text-info' },
